        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="updatemypassword" method="POST">
                <div class="mb-3">
              ...
              <br><br>
                <button class="btn btn-primary d-grid w-100" type="submit" value="Update Password">Update Password</button>
              </form>
...
<title>onlineGrocery | Update Password</title>
</head>
