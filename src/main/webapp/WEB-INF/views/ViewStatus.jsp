        ...
        <div class="layout-page">
         ...
         <h5 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> </span>Status</h5>
           ...
           <div class="row">
                <div class="col-md-9">
                  <div class="card mb-6">
             <h5 class="card-header">View Status</h5>
                    <div class="card-body">
                    </div>
...
<div>
	...
	<div>
	 <h7 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> </span>	Status :<%=statusBean.getStatus()%>
	 
	 
	 </h7>
	</div>
	<div>
	 <h7 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> </span>	 Deleted :<%=statusBean.getDeleted()%><br>
