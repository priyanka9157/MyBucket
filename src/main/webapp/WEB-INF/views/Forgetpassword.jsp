<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <title>mybucket | Forgot Password </title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Enter your email for reset password otp</p>
              <form id="formAuthentication" class="mb-3" action="sendotpforforgetpassword" method="POST">
                <div class="mb-3">
                  <label for="email" class="form-label">Email</label>
                  <input type="email" class="form-control" id="email" name="email" placeholder="Enter your email" autofocus="">
              <br><br><br>
          	    
                <button class="btn btn-primary d-grid w-100" type="submit" value="Send Otp">Send OTP</button>
              </form>
